...
style_img = imageLoader("./Data/picasso.jpg")
content_img = imageLoader("./Data/dancing.jpg")
...
plt.figure()
imageShow(style_img, title = 'Style Img')

plt.figure()
imageShow(content_img, title = 'Content Img')
...
def get_style_model_and_losses(cnn, normalization_mean, normalization_std, style_img, content_img, content_layers = content_layers_default, style_layers=style_layers_default):
    ...
    cnn = copy.deepcopy(cnn) #What is it doing?
...
plt.figure()
imageShow(input_img, title='Input Image')
...
def runStyleTransfer(cnn, normalization_mean, normalization_std, content_img, style_img, input_img, num_steps = 300, style_weight = 1000000, content_weight = 1):
...
output = runStyleTransfer(cnn, cnn_normalization_mean, cnn_normalization_std,content_img, style_img, input_img)
